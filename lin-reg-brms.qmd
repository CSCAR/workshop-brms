...
R has some clean data[^penguins] about three types of chilly fellows: Adelie, Chinstrap,
and Gentoo.

[^penguins]: Find more information on these data by running `help(penguins)` and referring to @kaye_2025_palmerpenguins.
...
in @fig-peng-hist suggests that Gentoo penguins tend to be the heaviest, while
Adelie and Chinstrap tend to have similar weights.

```{r visualize penguin weights}
#| code-fold: true
#| code-summary: Visualize penguin weights
#| warning: false
#| fig-align: center
#| fig-width: 4
#| fig-height: 4
